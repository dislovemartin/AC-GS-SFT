...
Show your complete reasoning process explicitly. Think step-by-step and explain your logical connections.`;
  ...
  private getFallbackResponse(request: GroqAnalysisRequest, processingTime: number): GroqAnalysisResponse {
    return {
      analysis: `Simulation-based reasoning analysis for LSU: "${request.lsu}". The QEC-SFT system has applied local reasoning algorithms to analyze this requirement. This LSU involves ${request.analysisType} considerations that have been evaluated using step-by-step logical analysis patterns.`,
      confidence: 0.5, // Moderate confidence for simulation
      recommendations: [
        'Apply systematic reasoning approach to requirement analysis',
        'Break down complex requirements into logical components',
        'Use step-by-step validation for each component',
        'Consider alternative interpretations and edge cases'
      ],
      riskFactors: [
        'External reasoning service unavailable - using simulation mode',
        'Complex logical structure may require expert reasoning review',
        'Multi-step reasoning process limited without full AI capabilities'
      ],
      technicalDetails: {
        mode: 'simulation',
        fallback: true,
        ...
        processingCapabilities: 'local logical analysis'
      },
      reasoning: 'Simulation reasoning: Applied local step-by-step analysis patterns to evaluate the LSU. The system identified key logical components but lacks full reasoning capabilities without external AI service.',
      processingTime
    };
  }
